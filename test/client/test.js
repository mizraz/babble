...
describe('Client-Server', function() {
  ...
  describe('API', function() {
    it('should issue GET /messages ', function() {
	  ...
	  console.log('in test of getMessages');
...
describe('Client', function() {
  it('should draw message to chat. msg-id-50', function() {
       
    drawMessage([{id: 'msg-id-50',
                        name: 'Raz',
                        email: 'mizraz@gmail.com',
                        date: new Date(),
                        message: 'hi there! consider me as annonymous!',
                        profilePicSrc: '../../client/images/annonymous.png'}]);

    var curMessage = document.getElementById('msg-id-50');
    console.log("@@@@@" + curMessage.querySelector('cite').innerText);
    assert.equal(curMessage.querySelector('cite').innerText, 'Raz');


  });

  it('should draw Stats to page:', function(){
    drawStats(JSON.stringify({clients: '40',
                        messages: 2040}));
    assert.equal('40',document.getElementById('count-users').innerText);
    assert.equal('2040',document.getElementById('count-messages').innerText);
